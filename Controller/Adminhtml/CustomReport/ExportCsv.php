...
{
    const ADMIN_RESOURCE = 'BCMarketplace_CustomReportSuite::customreport_export_report';
    /**
    ...
    /**
     * @var \BCMarketplace\CustomReportSuite\Controller\Adminhtml\CustomReport\Builder
     */
    private $builder;
     ...
     * @param \BCMarketplace\CustomReportSuite\Controller\Adminhtml\CustomReport\Builder $builder
     */
