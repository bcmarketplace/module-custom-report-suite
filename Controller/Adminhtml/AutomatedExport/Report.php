...
{
    const ADMIN_RESOURCE = 'BCMarketplace_CustomReportSuite::automatedexport_view_report';
    ...
    public function execute()
    {
        ...
        $resultPage->setActiveMenu('BCMarketplace_CustomReportSuite::automatedexport');
