...
use BCMarketplace\CustomReportSuite\Api\Data\AutomatedExportInterfaceFactory;
use Exception;
...
class Save extends Action
{
     ...
     * @see _isAllowed()
     */
    const ADMIN_RESOURCE = 'BCMarketplace_CustomReportSuite::automatedexport_save';
    ...
    /**
     * @var \BCMarketplace\CustomReportSuite\Api\AutomatedExportRepositoryInterface
     */
     ...
     * @param \BCMarketplace\CustomReportSuite\Api\Data\AutomatedExportInterfaceFactory $automatedExportFactory
     */
    ...
    public function execute(): ResultInterface
    {
        ...
        if ($data) {
            ...
            try {
                ...
                $this->dataPersistor->clear('bcmarketplace_customreportsuite_automatedexport');
                if ($this->getRequest()->getParam('back')) {
                    return $resultRedirect->setPath(
                        '*/*/edit',
                        ['schedule_id' => $automatedExport->getId(), '_current' => true]
                    );
                }
            ...
            $this->dataPersistor->set('bcmarketplace_customreportsuite_automatedexport', $data);
