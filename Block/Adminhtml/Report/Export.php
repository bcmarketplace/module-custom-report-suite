...
class Export extends \Magento\Backend\Block\Widget\Grid\Export
{
    ...
    /**
     * @return $this|\BCMarketplace\CustomReportSuite\Block\Adminhtml\Report\Export
     */
     ...
     * @param mixed $automatedExport
     * @return string
     */
    protected function replaceVariables(string $string, CustomReportInterface $customReport, $automatedExport): string
    {
