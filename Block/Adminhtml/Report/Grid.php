...
namespace BCMarketplace\CustomReportSuite\Block\Adminhtml\Report;
...
{
    /**
     * @var \BCMarketplace\CustomReportSuite\Registry\CurrentCustomReport
     */
    ...
    public function addColumnSet($dataItem)
    {
        ...
        foreach ($dataItem->getData() as $key => $val) {
            ...
            // Format header: convert underscores to spaces and title case
            ...
            $column = $this->_layout->createBlock(
                Column::class,
                'bcmarketplace_customreportsuite_grid.grid.column.'.$key,
                $data
            );
    ...
    public function addGridExportBlock(): Grid
    {
        ...
        $exportBlock = $this->_layout->createBlock(
            Export::class,
            'bcmarketplace_customreportsuite_grid.grid.export',
            $exportArguments
        );
