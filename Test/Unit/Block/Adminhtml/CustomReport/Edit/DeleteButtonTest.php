...
namespace BCMarketplace\CustomReportSuite\Test\Unit\Block\Adminhtml\CustomReport\Edit;

use BCMarketplace\CustomReportSuite\Block\Adminhtml\CustomReport\Edit\DeleteButton;
...
class DeleteButtonTest extends TestCase
{
    ...
    {
        $this->request->method('getParam')->with('report_id')->willReturn('1');
