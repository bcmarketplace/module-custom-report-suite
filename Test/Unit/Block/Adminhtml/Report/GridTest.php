...
namespace Tests\Unit\BCMarketplace\CustomReportSuite\Block\Adminhtml\Report;
...
class GridTest extends TestCase
{
    ...
    public function test_prepareLayout(): void
    {
        ...
        $genericCollectionMock = $this->createMock(\BCMarketplace\CustomReportSuite\Model\GenericReportCollection::class);
