...
namespace BCMarketplace\CustomReportSuite\Test\Unit\Block\Adminhtml\AutomatedExport\Edit;

use BCMarketplace\CustomReportSuite\Block\Adminhtml\AutomatedExport\Edit\DeleteButton;
...
class DeleteButtonTest extends TestCase
{
    ...
    {
        $this->request->method('getParam')->with('schedule_id')->willReturn('1');
