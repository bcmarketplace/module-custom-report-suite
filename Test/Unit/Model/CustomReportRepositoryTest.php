...
use BCMarketplace\CustomReportSuite\Model\CustomReportRepository;
...
class CustomReportRepositoryTest extends TestCase
{
    ...
    {
        $model = $this->createMock(\BCMarketplace\CustomReportSuite\Model\CustomReport::class);
    ...
    public function testGetList(): void
    {
        ...
        $collectionMock = $this->createMock(\BCMarketplace\CustomReportSuite\Model\ResourceModel\CustomReport\Collection
                                            ::class);
