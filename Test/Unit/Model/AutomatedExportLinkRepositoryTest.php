...
use BCMarketplace\CustomReportSuite\Model\AutomatedExportLinkRepository;
...
class AutomatedExportLinkRepositoryTest extends TestCase
{
    ...
    {
        $model = $this->createMock(\BCMarketplace\CustomReportSuite\Model\AutomatedExportLink::class);
    ...
    public function testGetList(): void
    {
        ...
        $collectionMock = $this->createMock(\BCMarketplace\CustomReportSuite\Model\ResourceModel\AutomatedExportLink\Collection
                                            ::class);
