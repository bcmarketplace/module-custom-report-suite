...
namespace BCMarketplace\CustomReportSuite\Test\Unit\Model\Config\Source;

use BCMarketplace\CustomReportSuite\Api\CustomReportRepositoryInterface;
use BCMarketplace\CustomReportSuite\Model\Config\Source\CustomReports;
...
class CustomReportsTest extends TestCase
{
    ...
    public function testToOptionArray(): void
    {
        ...
        $customReport = $this->createMock(\BCMarketplace\CustomReportSuite\Model\CustomReport::class);
