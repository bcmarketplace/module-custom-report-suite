...
namespace Tests\Unit\BCMarketplace\CustomReportSuite\Model\Service;

use BCMarketplace\CustomReportSuite\Model\Service\CreateDynamicCron;
...
class CreateDynamicCronTest extends TestCase
{
    ...
    {
        $automatedExport = $this->createMock(\BCMarketplace\CustomReportSuite\Model\AutomatedExport::class);
