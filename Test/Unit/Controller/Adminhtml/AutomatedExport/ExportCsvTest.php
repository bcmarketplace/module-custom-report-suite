...
use BCMarketplace\CustomReportSuite\Controller\Adminhtml\AutomatedExport\Builder;
use BCMarketplace\CustomReportSuite\Controller\Adminhtml\AutomatedExport\ExportCsv;
...
class ExportCsvTest extends TestCase
{
    ...
    public function testExecute(): void
    {
        ...
        $blockExport = $this->createMock(\BCMarketplace\CustomReportSuite\Block\Adminhtml\Report\Export::class);
