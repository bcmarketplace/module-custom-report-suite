...
class BuilderTest extends TestCase
{
    ...
    {
        $mockHelper = $this
            ->getMockBuilder(\BCMarketplace\CustomReportSuite\Model\CustomReport::class)
            ->disableOriginalConstructor()
            ->setMethods(['load'])
            ->getMockForAbstractClass();
    ...
    protected function getModel()
    {
        ...
        $model = $objectManager->getObject(
            \BCMarketplace\CustomReportSuite\Controller\Adminhtml\AutomatedExport\Builder::class,
            [
